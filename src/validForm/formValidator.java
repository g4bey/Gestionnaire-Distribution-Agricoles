...
/**
 * Lorsque l'on instancie un enfant de formValidator, l'on passe en parameters les champs,
...
public abstract class formValidator {
    ...
    /**
     * Permet d'ajouter un message d'erreur et de faire les sauts de lignes nécessaires.
